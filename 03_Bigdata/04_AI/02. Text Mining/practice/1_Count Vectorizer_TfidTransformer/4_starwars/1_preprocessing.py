...
# 사용모델: 스타워즈 에피소드 4 대본 ( http://www.kaggle.com/xvivancos/star-wars-movie-scripts )

# 종속변수: 등장인물들의 이름. 여기서는 주인공 luke의 대사에 따른 인물 이름 추측
protagonist_header = ' LUKE'
documents = []
labels = []
# 고정변수: 각 캐릭터들의 대사
# luke의 대사는 labels을 1을 주고 그 외 인물은 0을 준다.
